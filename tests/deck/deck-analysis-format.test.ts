...
import { card, carriedKeyword, taxonomy } from "../card/fixtures";
...
const mid = card("mid", "OGN", {
  ...
  classification: { typeId: "Spell", supertypeId: null, rarity: taxonomy("common") },
});
const rune = card("rune", "OGN", {
  name: "Power Rune",
  attributes: { energy: 2, might: null, power: null },
  classification: { typeId: "Rune", supertypeId: null, rarity: taxonomy("common") },
});
