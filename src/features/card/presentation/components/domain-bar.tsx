...
/**
 * A card's domains as one band along the bottom edge of its art, each domain filling its share of
 * the band with its color and its letter. A dual-domain card splits the band evenly so both read at
 ...
 */
function DomainBar({ domainIds }: { readonly domainIds: readonly CardDomain[] }) {
