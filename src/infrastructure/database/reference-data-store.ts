...
interface ReferenceDataStore {
  ...
  readonly coreRules: CoreRulesRepository;
  readonly keywords: KeywordLister;
  readonly sets: SetRepository;
}

/** Supplies card, core rules, keyword, and set repository capabilities backed by the app database. */
function createReferenceDataStore(
  ...
  return {
    ...
    coreRules: new SqliteCoreRulesRepository(db),
